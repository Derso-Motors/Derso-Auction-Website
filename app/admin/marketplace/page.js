...
const MAKES = [
  ...
  'סיטרואן', 'הונדה', 'סובארו', 'BMW', 'מרצדס', 'אאודי', 'וולוו',
...
function parseBidspirit(text) {
  ...
  // Title: first meaningful line or constructed from make+model+year
        ...
        <div className="admin-col-right">
          ...
          {data && (
            <div className="card">
              ...
              <div className="field">
                <label>הערות נוספות (יתווספו לתיאור)</label>
                <textarea
