...
export const CREDIT_PACKAGES = [
  ...
  { key: 'pro',      label: 'מקצועי',  credits: 560,  price: 504,  listPrice: 560,  discount: '10% הנחה', bonus: 60,  tag: null,            link: 'https://pay.grow.link/MTA0MzEx~b21eb5c7bd8bc4bd0fe0d65d618d050d-MzgyMDkyNg' },
  { key: 'premium',  label: 'פרימיום', credits: 1150, price: 862,  listPrice: 1150, discount: '25% הנחה', bonus: 150, tag: 'הכי משתלם',   link: 'https://pay.grow.link/MTA0MzEx~d3ce10aa6d89423c96f023624ae57796-MzgyMDkyOA' },
];
...
// Grow recurring (הוראת קבע) pages — fill in once created in the Grow dashboard.
export const GROW_BROADCAST_SUB_LINK = null; // ₪25/month broadcast subscription
export const GROW_AI_SUB_LINK = null;        // ₪15/month personal AI assistant
